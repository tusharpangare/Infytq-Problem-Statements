...
def find_passengers_destination(destination):
    ...
    for i in range (0,len(ticket_list)):
        if destination in ticket_list[i] and ticket_list[i].index(destination)==10: 
            count+=1
    return count
...
def sort_passenger_list():
    ...
    return passenger_per_flight
    # print(sort_list)
    #Write the logic to sort the list returned from find_passengers_per_flight() function in the descending order of number of passenger

    #Remove pass and write your logic here

#Provide different values for airline_name and destination and test your program.
# print(find_passengers_flight("AI"))
# print(find_passengers_destination("MUM"))
